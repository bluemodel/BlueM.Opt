...
namespace BlueM.Opt.Algos.MetaEvo
{
    class Algomanager
    {
        ...
        public void new_individuals_merge_with_genpool(ref BlueM.Opt.Common.Individuum_MetaEvo[] new_generation_input)
        {
            ...
            Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Input: Generated and Simulated Individuums: \r\n" + this.generationinfo(ref new_generation_input));
            ...
            if (settings.MetaEvo.OpMode == "Local Optimizer")
            {
                ...
                Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Result: New Genpool: \r\n" + this.generationinfo(ref genpool) + "\r\n");
            }
            ...
            Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Solutionvolume: Last Volume: " + solutionvolume.get_complete_infos());
        }
        ...
        public void set_genpool(ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_input)
        {
            ...
            Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Genpool: \r\n" + this.generationinfo(ref this.genpool));
        }
                        ...
                        for (int k = genpool_input.Length - 1; k > i; k--)
                        {
                            if (genpool_input[k].get_status() == "true")
                            {
                                ...
                                if (dominator > -1)
                                {
                                    ...
                                    Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Domination: Individuum " + genpool_input[k].ID + " is dominated (by Individuum " + genpool_input[dominator].ID + ")");
                                    dominator = -1;
                                }
                            }
                        }
                            ...
                            if ((input2[pointer_newgen].get_status() == "true") && (genpool_input[pointer_genpool].get_status() == "true"))
                            {
                                ...
                                switch (status)
                                {
                                    case -1:
                                        ...
                                        Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Domination: Individuum " + input2[pointer_newgen].ID + " is dominated (by Individuum " + genpool_input[pointer_genpool].ID + ")");
                                        break;

                                    case 1:
                                        genpool_input[pointer_genpool].set_status("false#dominated#" + input2[pointer_newgen].ID);
                                        Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Domination: Individuum " + genpool_input[pointer_genpool].ID + " is dominated (by Individuum " + input2[pointer_newgen].ID + ")");
                                        break;

                                    case 0:
                                        genpool_input[pointer_genpool].set_status("false#equal#" + input2[pointer_newgen].ID);
                                        Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Domination: Individuum " + genpool_input[pointer_genpool].ID + " equals Individuum " + input2[pointer_newgen].ID);
                                        break;
        ...
        private void crowding_selection(int killindividuums_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] input2)
        {
            ...
            Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Number of new Individuums has a difference to Genpool-size: +" + killindividuums_input + " -> Crowding Selection");
            ...
            while (killindividuums > 0)
            {
                ...
                densities[pointer] = 0;
                Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Crowding: Individuum " + work[pointer].ID + " is not used anymore");
        ...
        private void revive(int numberawake_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] input2)
        {
            ...
            Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Number of new Individuums has a difference to Genpool-size: " + numberawake_input + " -> Revive");
            ...
            while (numberawake_input < 0)
            {
                ...
                Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Diversity: Individuum " + work[pointer_highest_ranking].ID + " is used again");
        ...
        private void newGen_composition(ref BlueM.Opt.Common.Individuum_MetaEvo[] new_generation_input)
        {
            ...
            Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: nemGen_composition: Initiativ-sum: " + initiativensumme);
            ...
            Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: nemGen_composition: Individuuum-Composition for next Generation:\r\n" + log[algos.algofeedbackarray.Length]);


            //7. Initiative bei Bedarf erhöhen (Falls zur Berechnung zu klein)
            if (initiativensumme < 1.00)
            {
                Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: nemGen_composition: Initiative will be increased to the sum of 1(was too low for good calculation)");
        ...
        public void set_calculationmode_local(ref BlueM.Opt.Common.Individuum_MetaEvo[] new_generation_input)
        {
            ...
            {
                Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Reducing Genpool to " + settings.MetaEvo.NumberResults + " Individuums");
                ...
                Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Genpool for local Optimization: \r\n" + this.generationinfo(ref genpool) + "\r\n");
        ...
        public void set_calculationmode_global_finished(ref BlueM.Opt.Common.Individuum_MetaEvo[] new_generation_input)
        {
            if (settings.MetaEvo.NumberResults < genpool.Length)
            {
                ...
                copy_true_to(ref genpool, ref genpool2);
                genpool = genpool2;
                Common.Log.AddMessage(Common.Log.levels.info, "Algo Manager: Final Genpool: \r\n" + this.generationinfo(ref genpool) + "\r\n");
            }
        }
