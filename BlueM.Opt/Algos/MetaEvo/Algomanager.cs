...
namespace BlueM.Opt.Algos.MetaEvo
{
    class Algomanager
    {
        ...
        public BlueM.Opt.Common.Individuum_MetaEvo[] genpool;
        BlueM.Opt.Common.Individuum_MetaEvo[] wastepool;
        BlueM.Opt.Diagramm.Monitor monitor1;
        public Algos algos;
        bool firstrun = true;
        public BlueM.Opt.MO_Indicators.Solutionvolume2 solutionvolume;
        ...
        public Algomanager(ref BlueM.Opt.Common.Problem prob_input, ref BlueM.Opt.Common.Settings settings_input, int individuumnumber_input)
        {
            ...
            solutionvolume = new BlueM.Opt.MO_Indicators.Solutionvolume2(prob_input.NumPrimObjective, 5, 2);
        ...
        public void new_individuals_merge_with_genpool(ref BlueM.Opt.Common.Individuum_MetaEvo[] new_generation_input)
        {
            Random rand = new Random();
            int difference2genpool = 0;
            BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Input: Generated and Simulated Individuums: \r\n" + this.generationinfo(ref new_generation_input));
            ...
            if (settings.MetaEvo.OpMode == "Local Optimizer")
            {
                ...
                BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Result: New Genpool: \r\n" + this.generationinfo(ref genpool) + "\r\n");
            }
            ...
            BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Solutionvolume: Last Volume: " + solutionvolume.get_complete_infos());
        }

        //Erzeugt mit Hilfe von Algos die neuen Individuen
        public void new_individuals_build(ref BlueM.Opt.Common.Individuum_MetaEvo[] new_generation_input)
        {
        ...
        //Setzt den Genpool
        public void set_genpool(ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_input)
        {
            this.wastepool = new BlueM.Opt.Common.Individuum_MetaEvo[genpool_input.Length];
            this.genpool = new BlueM.Opt.Common.Individuum_MetaEvo[genpool_input.Length];
            for (int i = 0; i < genpool_input.Length; i++)
            {
                this.genpool[i] = genpool_input[i].Clone_MetaEvo();
            }
            BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Genpool: \r\n" + this.generationinfo(ref this.genpool));
        }

        //Wiederbelebte Feasible-Individuen wieder auf false setzen
        private void set_notfeasible2false(ref BlueM.Opt.Common.Individuum_MetaEvo[] input, ref BlueM.Opt.Common.Individuum_MetaEvo[] input2)
        {
        ...
        private void quicksort(ref BlueM.Opt.Common.Individuum_MetaEvo[] input, int kriterium, int low_input, int high_input)
        {
            int low = low_input;
            int high = high_input;
            double medianvalue = input[(low_input + high_input) / 2].PrimObjectives[kriterium];
            BlueM.Opt.Common.Individuum_MetaEvo individuum_tmp;
        ...
        private void check_domination(ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] input2)
        {
            int dominator = -1;
            int status = 0;
                        ...
                        for (int k = genpool_input.Length - 1; k > i; k--)
                        {
                            if (genpool_input[k].get_status() == "true")
                            {
                                ...
                                if (dominator > -1)
                                {
                                    ...
                                    BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Domination: Individuum " + genpool_input[k].ID + " is dominated (by Individuum " + genpool_input[dominator].ID + ")");
                                    dominator = -1;
                                }
                            }
                        }
                            ...
                            if ((input2[pointer_newgen].get_status() == "true") && (genpool_input[pointer_genpool].get_status() == "true"))
                            {
                                ...
                                switch (status)
                                {
                                    case -1:
                                        ...
                                        BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Domination: Individuum " + input2[pointer_newgen].ID + " is dominated (by Individuum " + genpool_input[pointer_genpool].ID + ")");
                                        break;

                                    case 1:
                                        genpool_input[pointer_genpool].set_status("false#dominated#" + input2[pointer_newgen].ID);
                                        BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Domination: Individuum " + genpool_input[pointer_genpool].ID + " is dominated (by Individuum " + input2[pointer_newgen].ID + ")");
                                        break;

                                    case 0:
                                        genpool_input[pointer_genpool].set_status("false#equal#" + input2[pointer_newgen].ID);
                                        BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Domination: Individuum " + genpool_input[pointer_genpool].ID + " equals Individuum " + input2[pointer_newgen].ID);
                                        break;
        ...
        private void crowding_selection(int killindividuums_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] input2)
        {
            int killindividuums = killindividuums_input;
            double[] densities = new double[genpool_input.Length + killindividuums];
            int pointer = 0;

            BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Number of new Individuums has a difference to Genpool-size: +" + killindividuums_input + " -> Crowding Selection");
            ...
            while (killindividuums > 0)
            {
                ...
                densities[pointer] = 0;
                BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Crowding: Individuum " + work[pointer].ID + " is not used anymore");
        ...
        private void revive(int numberawake_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] input2)
        {
            ...
            BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Number of new Individuums has a difference to Genpool-size: " + numberawake_input + " -> Revive");
            ...
            while (numberawake_input < 0)
            {
                ...
                BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Diversity: Individuum " + work[pointer_highest_ranking].ID + " is used again");
        ...
        private void zip(ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] input2)
        {
            int pointer_true = 0;
            int pointer_false = 0;
            BlueM.Opt.Common.Individuum_MetaEvo tmp;
        ...
        private string generationinfo(ref BlueM.Opt.Common.Individuum_MetaEvo[] generation)
        {
        ...
        private void newGen_composition(ref BlueM.Opt.Common.Individuum_MetaEvo[] new_generation_input)
        {
            ...
            BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: nemGen_composition: Initiativ-sum: " + initiativensumme);
            ...
            BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: nemGen_composition: Individuuum-Composition for next Generation:\r\n" + log[algos.algofeedbackarray.Length]);


            //7. Initiative bei Bedarf erhöhen (Falls zur Berechnung zu klein)
            if (initiativensumme < 1.00)
            {
                BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: nemGen_composition: Initiative will be increased to the sum of 1(was too low for good calculation)");
        ...
        private void copy_true_to(ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_output)
        {
            int index = 0;
            for (int i = 0; i < genpool_input.Length; i++)
            {
        ...
        //Kopiere true-Individuen auf neuen Genpool
        private void copy_some_to(ref BlueM.Opt.Common.Individuum_MetaEvo[] newgen_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] newgen_output)
        {
        ...
        public void set_calculationmode_local(ref BlueM.Opt.Common.Individuum_MetaEvo[] new_generation_input)
        {
            settings.MetaEvo.AlgoMode = "Local: Calculating";

            if (settings.MetaEvo.NumberResults < genpool.Length)
            {
                BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Reducing Genpool to " + settings.MetaEvo.NumberResults + " Individuums");
                ...
                BlueM.Opt.Common.Individuum_MetaEvo[] new_generation_input2 = new BlueM.Opt.Common.Individuum_MetaEvo[settings.MetaEvo.NumberResults * settings.MetaEvo.ChildrenPerParent];
                ...
                BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Genpool for local Optimization: \r\n" + this.generationinfo(ref genpool) + "\r\n");
        ...
        public void set_calculationmode_global_finished(ref BlueM.Opt.Common.Individuum_MetaEvo[] new_generation_input)
        {
            if (settings.MetaEvo.NumberResults < genpool.Length)
            {
                BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Reducing Genpool to " + settings.MetaEvo.NumberResults + " Individuums");
                ...
                copy_true_to(ref genpool, ref genpool2);
                genpool = genpool2;
                BlueM.Opt.Common.Log.AddMessage(BlueM.Opt.Common.Log.levels.info, "Algo Manager: Final Genpool: \r\n" + this.generationinfo(ref genpool) + "\r\n");
            }
        }

        //Mengendifferenz zwischen Genpoolgrösse und überlebenden Individuen
        private int calculate_difference2genpool(ref BlueM.Opt.Common.Individuum_MetaEvo[] genpool_input, ref BlueM.Opt.Common.Individuum_MetaEvo[] input2)
        {
            int alive = 0;
        ...
        private double[] calculate_densities(ref BlueM.Opt.Common.Individuum_MetaEvo[] work_input)
        {
