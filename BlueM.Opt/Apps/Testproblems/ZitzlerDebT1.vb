...
''' <summary>
''' Zitzler/Deb/Thiele T1: multicriteria test problem (convex)
''' </summary>
Public Class ZitzlerDebT1
    ...
    Public Overrides ReadOnly Property Description As String
        Get
            Return "Zitzler/Deb/Thiele T1: multicriteria test problem (convex)"
        End Get
    End Property
