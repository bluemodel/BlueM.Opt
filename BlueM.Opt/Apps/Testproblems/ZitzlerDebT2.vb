...
''' <summary>
''' Zitzler/Deb/Thiele T2: multicriteria test problem (concave)
''' </summary>
Public Class ZitzlerDebT2
    ...
    Public Overrides ReadOnly Property Description As String
        Get
            Return "Zitzler/Deb/Thiele T2: multicriteria test problem (concave)"
        End Get
    End Property
