...
-------------
NEW:
* Added a new objective function Annual Peak Flow Bias (APFB) after Mizukami et al., 2019 https://hess.copernicus.org/articles/23/2601/2019/

CHANGED:
* Parameter values written to model input files are now padded right instead of left with spaces to avoid issues with some simulation models
* Updated Talsim to v4.1.9
* Update BlueM.Wave to v2.12.3

FIXED:
* Fixed iteration break condition for parameter mutation of dependent parameters

Version 2.4.4
-------------
NEW:
* Added a button for highlighting solutions on mouse hover in the scatterplot matrix #240

Version 2.4.3
-------------
NEW:
* Added the possibility to select a solution by ID #237
FIXED:
* Added number of days to total optimization time output in log
* Added log messages and more information to message box in case of errors when selecting a solution
CHANGED:
* Updated BlueM.Wave to v2.7.1

Version 2.4.2
-------------
NEW:
* BlueM.Sim: added the file extensions YSP, AUA, SMZ, SBF, WTP as part of the dataset
CHANGED:
* Updated Steema.TeeChart to 4.2023.4.18
* Updated BlueM.Wave to v2.6.1
* Updated Talsim-NG Engine to v3.2.29
