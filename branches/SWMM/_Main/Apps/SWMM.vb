...
#Region "Methoden"
    ...
    Public Overrides Function launchSim() As Boolean
        ...
        ChDir(Me.WorkDir)
        'dll aufrufen
        RunSwmmDll("A128.inp", "A128.rpt", "A128.dat")
        ...
        '-------------------------------------
        If (File.Exists(WorkDir & Datensatz & ".RPT") = False) Then
            'RPT-Datei existiert nicht
            launchSim = False
            Exit Function
        Else
            launchSim = True
    ...
    Public Overrides Function QWert(ByVal OptZiel As Struct_OptZiel) As Double
        ...
        Select Case OptZiel.Datei
            ...
            Case "RPT"
                '14.11.07_SH: SWMM-Ergebnisse aus RPT-Datei auslesen
