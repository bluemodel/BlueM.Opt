Public Class Testprobleme
    ...
    Public Sub Zielfunktion_zeichnen_Sinus(ByRef TChart1 As Steema.TeeChart.TChart, ByRef AnzPar As Short, ByRef Par(,) As Double, ByRef durchlauf As Integer, ByRef ipop As Short)
        Dim i As Short
        Dim Unterteilung_X As Double
        Dim array_x() As Double = {}
        Dim array_y() As Double = {}
