    ...
    Public Sub ZeichneIstWerte()
        ...
        If (Me.ZielIndexX <> -1) Then
            If (Common.Manager.List_Ziele(Me.ZielIndexX).hasIstWert) Then
                ...
                colorline1.Value = Common.Manager.List_Ziele(Me.ZielIndexX).IstWert
            End If
        End If
...
#Region "Lösungsauswahl"
    ...
    '***************************
    Friend Sub ZeichneAusgewählteLösung(ByVal ind As Common.Individuum)
    ...
    '***************************************
    Friend Sub LöscheAusgewählteLösungen()
