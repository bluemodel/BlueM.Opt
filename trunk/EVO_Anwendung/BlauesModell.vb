...
Module BlauesModell
    ...
    Public Sub launchBM(ByVal Pfad As String, ByVal Datensatz As String)
        ...
        ChDir(workingDir)
        'EXE aufrufen
        ProcID = Shell("""D:\CODING\BlauesModell\Release\BlauesModell.exe"" " & Datensatz, AppWinStyle.NormalFocus, True)
