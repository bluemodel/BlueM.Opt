Public Class Individuum
    ...
    Public Shared Sub Initialise(ByVal _Individ_Type As Integer, ByVal _n_Locations As Integer, ByVal _n_Penalty As Integer, ByVal _n_Constrain As Integer)
    ...
    Public Sub New(ByVal _Type As String, ByVal _ID As Integer)
        ...
        For i = 0 To Me.Loc.GetUpperBound(0)
            ...
            ReDim Me.Loc(i).Loc_Para(1, 0)
            For j = 0 To Me.Loc(i).Loc_Para.GetUpperBound(1)
                Me.Loc(i).Loc_Para(0, j) = "xxx"
                Me.Loc(i).Loc_Para(1, j) = 777
            Next

            '11 Das Dn für PES
            ReDim Me.Loc(i).Loc_Dn(0)
            For j = 0 To Me.Loc(i).Loc_Dn.GetUpperBound(0)
                Me.Loc(i).Loc_Dn(j) = 777
            Next
    ...
    Public Function Copy() As Individuum
        ...
        For i = 0 To Me.Loc.GetUpperBound(0)
            ...
            ReDim Dest.Loc(i).Loc_Para(1, Me.Loc(i).Loc_Para.GetUpperBound(1))
            Array.Copy(Me.Loc(i).Loc_Para, Dest.Loc(i).Loc_Para, Me.Loc(i).Loc_Para.Length)
